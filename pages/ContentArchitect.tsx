...
const PROGRESS_STEPS = [
    ...
    { message: 'Writing the thread body...', icon: '📝', duration: 2000 },
    { message: 'Generating your brand visual...', icon: '🎨', duration: 2500 },
    { message: 'Polishing for maximum engagement...', icon: '✨', duration: 1000 },
];
...
export const ContentArchitect: React.FC = () => {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-10 font-['Outfit'] pb-20">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 border-b border-slate-100 pb-10">
                <div className="space-y-2">
                    ...
                    <h1 className="text-4xl font-extrabold text-slate-900 tracking-tight">Post Architect</h1>
                    <p className="text-slate-400 font-medium text-lg">Design, generate & publish viral Reddit threads in seconds.</p>
                </div>
